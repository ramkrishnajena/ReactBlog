...
const Signup = () => {
  ...
  return (
    <div className='w-full h-96 flex items-center justify-center'>
      <div className='w-1/3 flex flex-col items-center bg-white shadow-md py-10'>
        ...
        >
          <input
            ...
            className='w-3/4 h-8 my-2 bg-transparent text-sm pl-2 border border-slate-300 rounded-md focus:outline-none focus:border-primary focus:border-2'
          />
          <input
            type='email'
            name='email'
